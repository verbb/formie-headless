    ...
    <fieldset :aria-labelledby="getId()">
        ...
        <div class="mt-2 space-y-2">
            <div v-for="(option, index) in field.options" :key="index" class="flex items-center">
                <input :id="getId([index])" :name="getName()" :value="option.value" :required="field.required" type="radio" class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300">
